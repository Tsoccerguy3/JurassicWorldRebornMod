...
public class BlueprintEntity extends EntityHanging implements IEntityAdditionalSpawnData {
    ...
    public enum Type {
        ...
        MEGALODON(1074,671),
        LIVYATAN(1074,671),
        PATAGOTITAN(1074,671),
        MAIASAURA(1074,671),
        DEINOSUCHUS(1074,671),
        NIGERSAURUS(1074,671),
        ENDOCERAS(1074,671),
        ORTHOCERAS(1074,671),
        CAMEROCERAS(1074,671),
        GIGANOTOSAURUS(1074,671),
        THERIZINOSAURUS(1074,671),
        EDMONTOSAURUS(1074,671),
        CORYTHOSAURUS(1074,671),
        LAMBEOSAURUS(1074,671),
        DUNKLEOSTEUS(1074,671),
        DILOPHOSAURUS(1074,671),
        STEGOSAURUS(1074,671),
        TROODON(1074,671),
        MAJUNGASAURUS(1074,671);
