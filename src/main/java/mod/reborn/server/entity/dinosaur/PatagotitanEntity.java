...
{
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(PatagotitanEntity.class, DataSerializers.VARINT);

    public PatagotitanEntity(World world)
    {
        super(world);
