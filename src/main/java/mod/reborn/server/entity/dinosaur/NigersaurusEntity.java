...
{
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(NigersaurusEntity.class, DataSerializers.VARINT);

    public NigersaurusEntity(World world)
    {
        super(world);
