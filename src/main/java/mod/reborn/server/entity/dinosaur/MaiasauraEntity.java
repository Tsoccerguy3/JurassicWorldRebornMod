...
{
    private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(MaiasauraEntity.class, DataSerializers.VARINT);

    public MaiasauraEntity(World world)
    {
        super(world);
