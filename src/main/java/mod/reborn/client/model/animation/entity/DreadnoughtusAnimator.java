...
public class DreadnoughtusAnimator extends EntityAnimator<DreadnoughtusEntity> {
    ...
    protected void performAnimations(AnimatableModel model, DreadnoughtusEntity entity,
        ...
        AdvancedModelRenderer body    = model.getCube("body");     // core torso
        AdvancedModelRenderer stomach = model.getCube("Stomach");  // extra torso section (present in this model)
        ...
        AdvancedModelRenderer[] tail = new AdvancedModelRenderer[]{ tail7, tail6, tail5, tail4, tail3, tail2 };
        ...
        model.chainWave(new AdvancedModelRenderer[]{ hips, stomach, body }, idleSpeed * 0.6F, idleDegree * 0.45F, 2, ticks, 1.0F);
